...
export class QueryService {
  ...
  updateWO(WOData) {
    let WODataArray = [JSON.stringify(WOData.formValues), WOData.userId, WOData.isValid, WOData.lat, WOData.long, WOData.videoOptions, WOData.isVideoAvailable, WOData.insertDate, WOData.displayValue, Constants.status.saved,WOData.AssignedRecordTime, WOData.id];
    const updateQuery = "update " + Constants.saveWO.wOTable + " set " + Constants.saveWO.formValues + "=?," + Constants.saveWO.userId + "=?," + Constants.saveWO.isValid + "=?," + Constants.saveWO.lat + "=?," + Constants.saveWO.long + "=?," + Constants.saveWO.videoOptions + "=?," + Constants.saveWO.isVideoAvailable + "=?," + Constants.saveWO.insertDate + "=?," + Constants.saveWO.displayValue + "=?," + Constants.saveWO.recordType + "=?," + Constants.saveWO.AssignedRecordTime+"=? where " + Constants.saveWO.autoIncId + "=?";
  ...
  getDownloadedWOSearch(taskId, formId, assignmentId, limit, offset, searchBy, filter,date,fromDate,toDate) {
    let getQuery, condition;
    if (searchBy != Constants.nullValue && filter == Constants.nullValue) {
      if (taskId == Constants.nullValue && formId == Constants.nullValue) {
        getQuery = "select " + Constants.saveWO.assignmentId + "," + Constants.saveWO.displayValue + "," + Constants.saveWO.formValues + "," + Constants.saveWO.dueDate + "," + Constants.saveWO.formId + "," + Constants.saveWO.autoIncId + "," + Constants.saveWO.recordId + "," + Constants.saveWO.recordType + "," + Constants.saveWO.taskId +","+  Constants.saveWO.AssignedRecordTime+" from " + Constants.saveWO.wOTable + "  where " + Constants.saveWO.displayValue + " like '%" + searchBy + "%' and " + Constants.saveWO.taskId + " is not null and " + (fromDate?(Constants.saveWO.AssignedRecordTime +" BETWEEN " + "datetime" +"("+ "'" +fromDate+"'"+")"+ " AND " + "datetime" +"("+ "'" +toDate  + "'" +")" + " and "):"")+ Constants.saveWO.userId + "=? and (" + Constants.saveWO.recordType + "=" + Constants.status.new + " or " + Constants.saveWO.recordType + "=" + Constants.status.reassigned + ") limit " + limit + " offset  " + offset;
        condition = [this.commonService.getUserInfo().username];
      }
      else {
        getQuery = "select " + Constants.saveWO.assignmentId + "," + Constants.saveWO.displayValue + "," + Constants.saveWO.formValues + "," + Constants.saveWO.dueDate + "," + Constants.saveWO.formId + "," + Constants.saveWO.autoIncId + "," + Constants.saveWO.recordId + "," + Constants.saveWO.recordType + "," + Constants.saveWO.taskId +","+  Constants.saveWO.AssignedRecordTime+" from " + Constants.saveWO.wOTable +  "  where " + Constants.saveWO.displayValue + " like '%" + searchBy + "%' and " + Constants.saveWO.taskId + "=? and " + Constants.saveWO.formId + "=? and " + Constants.saveWO.assignmentId + "=? and " + ( fromDate?(Constants.saveWO.AssignedRecordTime+" BETWEEN " + "datetime" +"("+ "'" +fromDate+"'"+")"+ " AND " + "datetime" +"("+ "'" +toDate  + "'" +")" + " and "):"")+ Constants.saveWO.userId + "=? and (" + Constants.saveWO.recordType + "=" + Constants.status.new + " or " + Constants.saveWO.recordType + "=" + Constants.status.reassigned + ") limit " + limit + " offset  " + offset;
        condition = [taskId, formId, assignmentId, this.commonService.getUserInfo().username];
      }

    } else if (searchBy == Constants.nullValue && filter != Constants.nullValue) {
      if (taskId == Constants.nullValue && formId == Constants.nullValue) {
        getQuery = "select " + Constants.saveWO.assignmentId + "," + Constants.saveWO.displayValue + "," + Constants.saveWO.formValues + "," + Constants.saveWO.dueDate + "," + Constants.saveWO.formId + "," + Constants.saveWO.autoIncId + "," + Constants.saveWO.recordId + "," + Constants.saveWO.recordType + "," + Constants.saveWO.taskId + ","+ Constants.saveWO.AssignedRecordTime+ " from " + Constants.saveWO.wOTable +  "  where " + Constants.saveWO.taskId + " is not null and " + (fromDate?(Constants.saveWO.AssignedRecordTime + " BETWEEN " + "datetime" +"("+ "'" +fromDate+"'"+")"+ " AND " + "datetime" +"("+ "'" +toDate  + "'" +")" + " and "):"")+ Constants.saveWO.userId + "=? and "  + Constants.saveWO.recordType + "=? limit " + limit + " offset  " + offset;
        condition = [this.commonService.getUserInfo().username, Constants.statusValue[filter]];
      }
      else {
        getQuery = "select " + Constants.saveWO.assignmentId + "," + Constants.saveWO.displayValue + "," + Constants.saveWO.formValues + "," + Constants.saveWO.dueDate + "," + Constants.saveWO.formId + "," + Constants.saveWO.autoIncId + "," + Constants.saveWO.recordId + "," + Constants.saveWO.recordType + "," + Constants.saveWO.taskId +","+  Constants.saveWO.AssignedRecordTime+ " from " + Constants.saveWO.wOTable +  "  where " + Constants.saveWO.taskId + "=? and " + Constants.saveWO.formId + "=? and " + Constants.saveWO.assignmentId + "=? and " + (fromDate?(Constants.saveWO.AssignedRecordTime + " BETWEEN " + "datetime" +"("+ "'" +fromDate+"'"+")"+ " AND " + "datetime" +"("+ "'" +toDate  + "'" +")" + " and "):"")+ Constants.saveWO.userId + "=? and " + Constants.saveWO.recordType + "=? limit " + limit + " offset  " + offset;
        condition = [taskId, formId, assignmentId, this.commonService.getUserInfo().username, Constants.statusValue[filter]];
      }
    } else if (searchBy != Constants.nullValue && filter != Constants.nullValue) {

      if (taskId == Constants.nullValue && formId == Constants.nullValue) {
        getQuery = "select " + Constants.saveWO.assignmentId + "," + Constants.saveWO.displayValue + "," + Constants.saveWO.formValues + "," + Constants.saveWO.dueDate + "," + Constants.saveWO.formId + "," + Constants.saveWO.autoIncId + "," + Constants.saveWO.recordId + "," + Constants.saveWO.recordType + "," + Constants.saveWO.taskId +","+ Constants.saveWO.AssignedRecordTime + " from " + Constants.saveWO.wOTable + "  where " + Constants.saveWO.displayValue + " like '%" + searchBy + "%' and " + Constants.saveWO.taskId + " is not null and " + Constants.saveWO.userId + "=? and " + (fromDate?(Constants.saveWO.AssignedRecordTime + " BETWEEN " + "datetime" +"("+ "'" +fromDate+"'"+")"+ " AND " + "datetime" +"("+ "'" +toDate  + "'" +")" + " and "):"")+ Constants.saveWO.recordType + "=? and "  +" limit " + limit + " offset  " + offset;
        condition = [this.commonService.getUserInfo().username, Constants.statusValue[filter]];
      }
      else {
        getQuery = "select " + Constants.saveWO.assignmentId + "," + Constants.saveWO.displayValue + "," + Constants.saveWO.formValues + "," + Constants.saveWO.dueDate + "," + Constants.saveWO.formId + "," + Constants.saveWO.autoIncId + "," + Constants.saveWO.recordId + "," + Constants.saveWO.recordType + "," + Constants.saveWO.taskId +","+  Constants.saveWO.AssignedRecordTime+ " from " + Constants.saveWO.wOTable + "  where " + Constants.saveWO.displayValue + " like '%" + searchBy + "%' and " + Constants.saveWO.taskId + "=? and " + Constants.saveWO.formId + "=? and " + Constants.saveWO.assignmentId + "=? and " + (fromDate?(Constants.saveWO.AssignedRecordTime + " BETWEEN " + "datetime" +"("+ "'" +fromDate+"'"+")"+ " AND " + "datetime" +"("+ "'" +toDate  + "'" +")" + " and "):"")+ Constants.saveWO.userId + "=? and " + Constants.saveWO.recordType + "=? limit " + limit + " offset  " + offset;
        condition = [taskId, formId, assignmentId, this.commonService.getUserInfo().username, Constants.statusValue[filter]];
      }
    } 
    else {
      if(taskId == Constants.nullValue && formId == Constants.nullValue){
        getQuery = "select " + Constants.saveWO.assignmentId + "," + Constants.saveWO.displayValue + "," + Constants.saveWO.formValues + "," + Constants.saveWO.dueDate + "," + Constants.saveWO.formId + "," + Constants.saveWO.autoIncId + "," + Constants.saveWO.recordId + "," + Constants.saveWO.recordType + "," + Constants.saveWO.taskId +","+ Constants.saveWO.AssignedRecordTime + " from " + Constants.saveWO.wOTable + "  where " + Constants.saveWO.taskId + " is not null and " + Constants.saveWO.userId + "=? and " + (fromDate?(Constants.saveWO.AssignedRecordTime + " BETWEEN " + "datetime" +"("+ "'" +fromDate+"'"+")"+ " AND " + "datetime" +"("+ "'" +toDate  + "'" +")" + " and "):"") + Constants.saveWO.recordType + "=? and " +" limit " + limit + " offset " + offset;
        condition = [this.commonService.getUserInfo().username];
      }
      else{
        getQuery = "select " + Constants.saveWO.assignmentId + "," + Constants.saveWO.displayValue + "," + Constants.saveWO.formValues + "," + Constants.saveWO.dueDate + "," + Constants.saveWO.formId + "," + Constants.saveWO.autoIncId + "," + Constants.saveWO.recordId + "," + Constants.saveWO.recordType + "," + Constants.saveWO.taskId +","+ Constants.saveWO.AssignedRecordTime + " from " + Constants.saveWO.wOTable + "  where " +  Constants.saveWO.taskId + "=? and " + Constants.saveWO.formId + "=? and " +  Constants.saveWO.assignmentId + "=? and " + (fromDate?(Constants.saveWO.AssignedRecordTime + " BETWEEN " + "datetime" +"("+ "'" +fromDate+"'"+")"+ " AND " + "datetime" +"("+ "'" +toDate  + "'" +")" + " and "):"") + Constants.saveWO.userId + "=? and (" + Constants.saveWO.recordType + "="+  Constants.status.new + " or "+ Constants.saveWO.recordType + "="+ Constants.status.reassigned +" ) limit " + limit + " offset  " + offset;
        condition = [taskId, formId, assignmentId, this.commonService.getUserInfo().username];
      }
    }
